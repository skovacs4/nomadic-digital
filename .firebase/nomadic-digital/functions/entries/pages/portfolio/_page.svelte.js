...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<section class="max-w-[1600px] mx-auto px-6 md:px-12 py-48 text-center" data-aos="fade-up"><h1 class="text-6xl md:text-8xl tracking-tight leading-[1.05] mb-24">${escape_html(store_get($$store_subs ??= {}, "$t", t)("portfolio.pageTitle"))}</h1> `);
    Portfolio($$renderer2);
