...
function ClientsV2($$renderer, $$props) {
  ...
  $$renderer.push(`<section class="max-w-[1600px] mx-auto px-4 md:px-0 py-36"><div class="flex items-center gap-24 mb-20"><div class="flex items-center gap-3"><span class="w-6 h-6 rounded-full border border-black flex items-center justify-center"><span class="text-sm leading-none">+</span></span> <h2 class="font-geist text-base font-bold">Our clients</h2></div> <p class="font-inter text-sm text-black/40 font-bold">(Long term partnerships built on trust)</p></div> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"><!--[-->`);
